...
namespace CurrencyStore.Web.App_Class
{
    public class ServiceBasePage : BasePage
    {
        ...
        public void SetOrgSearchByPermission(TextBox txtOrgName, HiddenField hfOrgId)
        {
            txtOrgName.AddOrgSelector(this.UserId);

            if (this.CurrentUserRole.DataFilter == (int)UserRole.DataFilterEnum.NoFilter)
            {
                txtOrgName.Text = "";
                hfOrgId.Value = "0";
            }
        ...
        public void SetDateTimeSearch(TextBox txtStartTime, TextBox txtEndTime)
        {
