...
namespace CurrencyStore.Communication
{
    ...
    internal delegate void DataReceivedCallback(ServerConnection sender, DataEventArgs e);
    /// <summary>
    ...
    public class ServerConnection
    {
        ...
        internal ServerConnection(Socket socket, SocketAsyncEventArgs args, DataReceivedCallback dataReceived,
