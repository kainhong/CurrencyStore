    ...
    public partial class Currency_Info_List : ServiceBasePage
    {
        ...
        protected new void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                //this.txtStartTime.Text = this.GetStartTime(1);
                //this.txtEndTime.Text = this.GetEndTime(1);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (currencyInfoPaging.RowCount > 5000)
            {
                this.JscriptMsg("单次导出数据量不能超过5000", null, "Error");
