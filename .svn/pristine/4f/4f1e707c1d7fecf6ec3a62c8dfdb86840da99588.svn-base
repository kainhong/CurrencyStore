...
namespace CurrencyStore.Repository
{
    public static class DbHelper
    {
        ...
        public static DbConnection GetDbConnection(string name)
        {
            ...
            if (ConfigurationManager.AppSettings["UnityContainerName"] == "mysql")
            {
                factory = DbProviderFactories.GetFactory("MySql.Data.MySqlClient");
            }

            if (ConfigurationManager.AppSettings["UnityContainerName"] == "oracle")
            {
        ...
        public static DbProvider GetProvider(this DbConnection con)
        {
            if (con.GetType().Name == "OracleConnection")
                ...
                return new MySql.MySqlDbProvider(con);
        }
