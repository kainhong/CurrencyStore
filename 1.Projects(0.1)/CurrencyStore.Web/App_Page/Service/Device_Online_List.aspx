<%@ Page Title="" Language="C#" MasterPageFile="~/App_Page/Service/ListPage.Master"
    AutoEventWireup="true" CodeBehind="Device_Online_List.aspx.cs" Inherits="CurrencyStore.Web.App_Page.Service.Device_Online_List" %>
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                采集系统名称：
                <asp:TextBox ID="txtCollectorName" MaxLength="16" runat="server" CssClass="txtInput"></asp:TextBox>
                <br />
                设备地址：
                <asp:TextBox ID="txtDeviceIp" MaxLength="16" runat="server" CssClass="txtInput"></asp:TextBox>
                连接状态：
                <asp:DropDownList ID="ddlConnectionStatus" CssClass="select2" runat="server">
                </asp:DropDownList>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphList" runat="server">
    <asp:GridView ID="gvList" CssClass="msgtable" runat="server" AutoGenerateColumns="False"
        GridLines="None" EmptyDataText="暂无数据" ShowHeaderWhenEmpty="True" DataKeyNames="PkId,DeviceNumber,ConnectionStatus"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="设备地址">
                <ItemTemplate>
                    <%#Eval("DeviceIp")%>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="采集系统名称">
                <ItemTemplate>
                    <%#Eval("CollectorName")%>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="采集系统地址">
                <ItemTemplate>
                    <%#Eval("CollectorIp")%>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="连接状态">
                <ItemTemplate>
                    <%#Eval("ConnectionStatus").ToString().GetConnectionStatusText()%>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="连接时间">
                <ItemTemplate>
                    <%#Eval("ConnectTime")%>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="断开时间">
                <ItemTemplate>
                    <%#Eval("DisconnectTime")%>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="上传张数">
                <ItemTemplate>
                    <%#Eval("UploadCount")%>
                </ItemTemplate>
            </asp:TemplateField>
