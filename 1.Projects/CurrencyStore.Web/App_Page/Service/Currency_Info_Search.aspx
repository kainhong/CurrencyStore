<%@ Page Title="" Language="C#" MasterPageFile="~/App_Page/Service/ListPage.Master"
    AutoEventWireup="true" CodeBehind="Currency_Info_Search.aspx.cs" Inherits="CurrencyStore.Web.App_Page.Service.Currency_Info_Search" %>
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                <br />
                纸币号码：
                <asp:TextBox ID="txtCurrencyNumberA" MaxLength="16" runat="server" CssClass="txtInput"></asp:TextBox>
                纸币号码：
                <asp:TextBox ID="txtCurrencyNumberB" MaxLength="16" runat="server" CssClass="txtInput"></asp:TextBox>
                <br />
                纸币号码：
                <asp:TextBox ID="txtCurrencyNumberC" MaxLength="16" runat="server" CssClass="txtInput"></asp:TextBox>
                纸币号码：
                <asp:TextBox ID="txtCurrencyNumberD" MaxLength="16" runat="server" CssClass="txtInput"></asp:TextBox>
